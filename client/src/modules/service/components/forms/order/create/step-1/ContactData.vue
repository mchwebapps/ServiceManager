<template>
  ...
  <ContactDataEditModal :customerId="customerId" :contact="contactData" @refresh="refreshContacts()" />
</template>
...
const contactData = ref<CommonCustomerContactDTO>(new CommonCustomerContactDTO)
