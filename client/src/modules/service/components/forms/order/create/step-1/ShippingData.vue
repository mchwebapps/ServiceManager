<template>
  ...
  <ShippingDataEditModal :customerId="customerId" :shipping="shippingData" @refresh="refreshShippings()" />
</template>
...
const shippingData = ref<CommonCustomerShippingDTO>(new CommonCustomerShippingDTO)
const editShipping = (shipping: any) => {
