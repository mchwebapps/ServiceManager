  ...
  <div class="container">
    <div class="row justify-content-between">
      ...
      <div class="col-2 col-md-4 col-lg-4">
        <RouterLink :to="{ name: 'service-parameter-create' }" class="btn btn-sm btn-primary float-end my-3 ms-auto">Dodaj</RouterLink>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
          ...
          <table class="table table-hover text-center align-middle fs-6">
            ...
            <tbody>
              <tr v-for="parameter in parameters" :key="parameter.id">
                <td>
                  <RouterLink :to="{ name: 'service-parameter-view', params: { id: parameter.id } }" class="text-decoration-none">
                    {{ parameter.name }}
                  </RouterLink>
                </td>
...
const cols = ['Parametr', 'Alias', 'Rodzaj', 'Akcje']
const subtitle = ParameterCategoryHelper.getParameterCategoryName(ParameterCategories.Service)
