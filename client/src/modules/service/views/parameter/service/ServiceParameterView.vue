<template>
  ...
  <ServiceParameterEditForm :parameterId="parameterId" :parameterCategory="parameterCategory" />
</template>
...
import ServiceParameterEditForm from "@/modules/service/components/forms/parameter/service/ServiceParameterEditForm.vue"
