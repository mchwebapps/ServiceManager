  ...
  <div class="container my-5">
    ...
    <div class="row justify-content-between">
      ...
      <div class="col-2 col-md-4 col-lg-4">
        <RouterLink :to="{ name: 'service-create' }" class="btn btn-sm btn-primary float-end my-3 ms-auto">Dodaj</RouterLink>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
          ...
          <table class="table table-hover text-center align-middle fs-6">
            ...
            <tbody>
              <tr v-for="service in services" :key="service.id">
                <td>
                  <RouterLink :to="{ name: 'service-view', params: { id: service.id } }" class="text-decoration-none">
                    {{ service.name }}
                  </RouterLink>
                </td>
                <td>
...
const deleteService = (serviceId: number) => {
  try {
    Swal.fire({
      icon: 'question',
      html: 'Czy na pewno chcesz usunąć tę usługę?',
