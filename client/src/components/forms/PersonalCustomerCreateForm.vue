<template>
  <div class="container" id="individual-client-form">
    ...
    <div class="row bg-light border rounded m-0 py-3 px-2">
      ...
      <div class="col-12 col-md-6 col-lg-4 mb-3">
        ...
        <input type="text" class="form-control" placeholder="Wpisz miejscowość" autocomplete="off" v-model="customer.city">
      </div>
      <div class="col-12 col-md-6 col-lg-4 mb-3">
        <label class="form-label">Kraj*:</label>
        <input type="text" class="form-control" placeholder="Wpisz miejscowość" autocomplete="off" v-model="customer.country">
      </div>
    </div>
    <hr>
    <div class="row bg-light border rounded m-0 py-3 px-2">
...
const createPersonalClient = async () => {
  try {
    submitBtnLock.value = true
    validationErrors.value = []
    customer.value.customerType = CustomerTypes.Personal
